...
const uint32_t TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::mprpc::RpcHeader, _impl_.argszie_),
};
...
const ::_pbi::DescriptorTable descriptor_table_rpcheader_2eproto = {
    false, false, 103, descriptor_table_protodef_rpcheader_2eproto,
    "rpcheader.proto",
...
RpcHeader::RpcHeader(const RpcHeader& from)
  ...
  _this->_impl_.argszie_ = from._impl_.argszie_;
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          _impl_.argszie_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* RpcHeader::_InternalSerialize(
  ...
  // uint32 argSzie = 3;
  if (this->_internal_argszie() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(3, this->_internal_argszie(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:mprpc.RpcHeader)
  ...
  // uint32 argSzie = 3;
  if (this->_internal_argszie() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_argszie());
  }
...
void RpcHeader::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_argszie() != 0) {
    _this->_internal_set_argszie(from._internal_argszie());
  }
...
void RpcHeader::InternalSwap(RpcHeader* other) {
  ...
  swap(_impl_.argszie_, other->_impl_.argszie_);
}
