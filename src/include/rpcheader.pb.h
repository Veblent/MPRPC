...
class RpcHeader final :
 ...
 public:
  ...
  // uint32 argSzie = 3;
  void clear_argszie();
  uint32_t argszie() const;
  void set_argszie(uint32_t value);
  private:
  uint32_t _internal_argszie() const;
  void _internal_set_argszie(uint32_t value);
  public:
...
// uint32 argSzie = 3;
inline void RpcHeader::clear_argszie() {
  _impl_.argszie_ = 0u;
}
inline uint32_t RpcHeader::_internal_argszie() const {
  return _impl_.argszie_;
}
inline uint32_t RpcHeader::argszie() const {
  // @@protoc_insertion_point(field_get:mprpc.RpcHeader.argSzie)
  return _internal_argszie();
}
inline void RpcHeader::_internal_set_argszie(uint32_t value) {
  
  _impl_.argszie_ = value;
}
inline void RpcHeader::set_argszie(uint32_t value) {
  _internal_set_argszie(value);
  // @@protoc_insertion_point(field_set:mprpc.RpcHeader.argSzie)
}
