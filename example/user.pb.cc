...
const uint32_t TableStruct_user_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::RegisterResponse, _impl_.ret_),
...
const char descriptor_table_protodef_user_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "esponse\022\037\n\003ret\030\001 \001(\0132\022.fixbug.ResultCode"
  "\022\017\n\007success\030\002 \001(\010\",\n\017RegisterRequest\022\014\n\004"
  "name\030\001 \001(\014\022\013\n\003pwd\030\002 \001(\014\"D\n\020RegisterRespo"
  "nse\022\037\n\003ret\030\001 \001(\0132\022.fixbug.ResultCode\022\017\n\007"
  "success\030\002 \001(\0102\204\001\n\016UserServiceRpc\0224\n\005Logi"
  "n\022\024.fixbug.LoginRequest\032\025.fixbug.LoginRe"
  "sponse\022<\n\007Regster\022\027.fixbug.RegisterReque"
  "st\032\030.fixbug.RegisterResponseB\003\200\001\001b\006proto"
  "3"
  ;
static ::_pbi::once_flag descriptor_table_user_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_user_2eproto = {
    false, false, 441, descriptor_table_protodef_user_2eproto,
    "user.proto",
...
class LoginResponse::_Internal {
 public:
  static const ::fixbug::ResultCode& ret(const LoginResponse* msg);
};
...
class RegisterResponse::_Internal {
 public:
  static const ::fixbug::ResultCode& ret(const RegisterResponse* msg);
};

const ::fixbug::ResultCode&
RegisterResponse::_Internal::ret(const RegisterResponse* msg) {
  return *msg->_impl_.ret_;
}
...
void RegisterResponse::InternalSwap(RegisterResponse* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(RegisterResponse, _impl_.ret_)>(
          reinterpret_cast<char*>(&_impl_.ret_),
          reinterpret_cast<char*>(&other->_impl_.ret_));
}
...
void UserServiceRpc::Regster(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::fixbug::RegisterRequest*,
                         ::fixbug::RegisterResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method Regster() not implemented.");
  done->Run();
}
...
void UserServiceRpc_Stub::Regster(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
